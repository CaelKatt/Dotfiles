...
sudo apt install -y git gdm3 i3 i3blocks i3lock lxappearance materia-gtk-theme tmux feh mc alacritty neovim xz-utils shutter thunar deluge neofetch gedit pulseaudio flatpak cmatrix
