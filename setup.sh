...
sudo apt install -y git gdm3 i3 i3blocks i3lock lxappearance materia-gtk-theme tmux feh mc alacritty flameshot neovim xz-utils shutter thunar deluge neofetch gedit pulseaudio flatpak cmatrix ninja-build gettext libtool libtool-bin autoconf automake cmake g++ pkg-config unzip doxygen fzf
