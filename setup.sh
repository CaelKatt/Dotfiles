...
sudo apt install -y git gdm3 i3 i3blocks i3lock lxappearance materia-gtk-theme feh mc alacritty neovim xz-utils shutter thunar neofetch gedit pulseaudio flatpak cmatrix
